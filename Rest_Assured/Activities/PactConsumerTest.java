...
public class PactConsumerTest {
    ...
    public RequestResponsePact createPact(PactDslWithProvider builder) throws ParseException {
        ...
        DslPart requestResponseBody = new PactDslJsonBody()
                .numberType("id", 1)
                .stringType("firstName", "Naga")
                .stringType("lastName", "Mahi")
                .stringType("email", "NagaMahi@test.com");
    ...
    public void runTest() {
        ...
        map.put("id", 1);
        map.put("firstName", "Naga");
        map.put("lastName", "Mahi");
        map.put("email", "NagaMahi@test.com");
